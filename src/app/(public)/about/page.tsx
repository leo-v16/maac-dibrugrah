      ...
      <section className="pb-32 relative overflow-hidden bg-deep-navy">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center md:text-left">
            ...
            <p className="text-xl md:text-2xl text-white/80 leading-relaxed font-sans mb-16 italic">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 pt-12 text-left">
